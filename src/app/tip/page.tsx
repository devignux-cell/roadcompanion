...
const TIPS = [
  { name: "Cash App", handle: "$RoamCompanion", icon: "💚", color: "#00D632", url: "https://cash.app/$RoamCompanion" },
  { name: "Venmo", handle: "@RoamCompanion", icon: "💙", color: "#3D95CE", url: "https://venmo.com/RoamCompanion" },
  { name: "PayPal", handle: "RoamCompanion", icon: "💛", color: "#FFB700", url: "https://paypal.me/RoamCompanion" },
] as const;
  ...
  return (
    <PageWrapper>
      <div style={{ padding: "24px 16px 40px" }}>
        <BackHeader title="Tip Jar" onBack={() => router.push("/")} />
