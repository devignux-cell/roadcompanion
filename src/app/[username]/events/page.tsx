      ...
      <div style={{ padding: "24px 16px 40px" }}>
        ...
        <div style={{ marginTop: 8, marginBottom: 24 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4 }}>
            <div style={{ fontSize: 14, color: COLORS.muted }}>Tampa events this week &amp; beyond</div>
            {isLive && (
              <div style={{
                display: "inline-flex", alignItems: "center", gap: 4,
                background: "rgba(45,255,199,0.1)", border: "1px solid rgba(45,255,199,0.2)",
                borderRadius: 100, padding: "2px 8px", fontSize: 10, color: COLORS.teal, fontWeight: 700,
              }}>
