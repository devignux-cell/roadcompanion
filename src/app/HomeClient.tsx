...
export default function HomeClient({ weather, username }: HomeClientProps) {
  ...
  const TILES = [
    {
      ...
      href: `/${username}/games`,
      color: COLORS.accent,
      subtitle: "Trivia · Leaderboard",
      delay: 0,
    },
    {
      label: "Recommendations",
      icon: null,
      href: `/${username}/recommendations`,
      color: COLORS.teal,
      subtitle: "Food · Events · Spots",
      delay: 60,
    },
    {
      label: "Stay",
      icon: "✈️" as string | null,
      href: `/${username}/travel`,
      color: COLORS.gold,
      ...
      <div style={{ padding: "0 0 40px" }}>
        ...
        >
          ...
          >
            {account?.bio
              ? account.bio
              : "Sit back and enjoy the ride — play trivia, discover Tampa's best spots, check out local events, and more."}
          </div>
        </div>
            ...
            <Link key={tile.href} href={tile.href} style={{ textDecoration: "none", flex: 1 }}>
              <div
                ...
                style={{
                  ...
                  transition: `opacity 0.5s ease ${tile.delay}ms, transform 0.5s ease ${tile.delay}ms`,
                }}
              >
                <div
                  style={{
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: tile.icon ? 22 : undefined,
                  }}
                >
                  {tile.icon ?? <RecsIcon />}
                </div>
        ...
        <div style={{ padding: "12px 16px 0" }}>
          <div
            style={{
              background: `linear-gradient(145deg, ${COLORS.card} 60%, rgba(245,200,66,0.06))`,
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 10, marginBottom: 20, position: "relative" }}>
              {[0, 1, 2, 3, 4].map((i) => (
                <span
                  ...
                  style={{
                    fontSize: 30,
                    animation: `starPulse 2.2s ease-in-out ${i * 130}ms infinite`,
            ...
            >
              Your rating makes a real difference.<br />
