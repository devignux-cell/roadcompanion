    ...
    >
      ...
      <div style={{ padding: "14px 16px 16px" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
          <div style={{ fontWeight: 700, fontSize: 15, color: COLORS.text, lineHeight: 1.3, flex: 1 }}>
            {item.title}
          </div>
          <div style={{ fontSize: 12, color: COLORS.muted, fontWeight: 500, flexShrink: 0, paddingTop: 2 }}>
            {item.detail}
          </div>
        </div>
...
export default function RecommendationsClient({ items, isLive }: Props) {
  ...
  return (
    <PageWrapper>
      <div style={{ padding: "24px 0 40px" }}>
        ...
        <div
          style={{
            display: "flex", gap: 8, paddingLeft: 16, paddingRight: 16,
            overflowX: "auto", paddingBottom: 4, marginBottom: 20,
          }}
        >
          {REC_FILTERS.map((f) => (
            <div
